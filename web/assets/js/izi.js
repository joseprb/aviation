    ...
    return (
        (h.prototype = {
            ...
            init: function (e, i) {
                var n = this;
                (this.$element = t(e)),
                    void 0 !== this.$element[0].id && "" !== this.$element[0].id ? (this.id = this.$element[0].id) : ((this.id = a + Math.floor(1e7 * Math.random() + 1)), this.$element.attr("id", this.id)),
                    ...
                    (this.headerHeight = 0),
                    (this.modalHeight = 0),
                    (this.$overlay = t('<div class="' + a + '-overlay" style="background-color:' + i.overlayColor + '"></div>')),
                    (this.$navigate = t('<div class="' + a + '-navigate"><div class="' + a + '-navigate-caption">Use</div><button class="' + a + '-navigate-prev"></button><button class="' + a + '-navigate-next"></button></div>')),
                    (this.group = { name: this.$element.attr("data-" + a + "-group"), index: null, ids: [] }),
                    this.$element.attr("aria-hidden", "true"),
                    this.$element.attr("aria-labelledby", this.id),
                    this.$element.attr("role", "dialog"),
                    this.$element.hasClass("iziModal") || this.$element.addClass("iziModal"),
                    void 0 === this.group.name && "" !== i.group && ((this.group.name = i.group), this.$element.attr("data-" + a + "-group", i.group)),
                    this.options.loop === !0 && this.$element.attr("data-" + a + "-loop", !0),
                    ...
                    i.iframe === !0
                        ? (this.$element.html('<div class="' + a + '-wrap"><div class="' + a + '-content"><iframe class="' + a + '-iframe"></iframe>' + this.content + "</div></div>"),
                          null !== i.iframeHeight && this.$element.find("." + a + "-iframe").css("height", i.iframeHeight))
                    ...
                    "" !== i.padding && this.$element.find("." + a + "-content").css("padding", i.padding),
                    "" !== i.theme && ("light" === i.theme ? this.$element.addClass(a + "-light") : this.$element.addClass(i.theme)),
            ...
            createHeader: function () {
                (this.$header = t(
                    '<div class="' + a + '-header"><h2 class="' + a + '-header-title">' + this.options.title + '</h2><p class="' + a + '-header-subtitle">' + this.options.subtitle + '</p><div class="' + a + '-header-buttons"></div></div>'
                )),
                    this.options.closeButton === !0 && this.$header.find("." + a + "-header-buttons").append('<a href="javascript:void(0)" class="' + a + "-button " + a + '-button-close" data-' + a + "-close></a>"),
                    this.options.fullscreen === !0 && this.$header.find("." + a + "-header-buttons").append('<a href="javascript:void(0)" class="' + a + "-button " + a + '-button-fullscreen" data-' + a + "-fullscreen></a>"),
                    this.options.timeoutProgressbar !== !0 ||
                        isNaN(parseInt(this.options.timeout)) ||
                        this.options.timeout === !1 ||
                        0 === this.options.timeout ||
                        this.$header.prepend('<div class="' + a + '-progressbar"><div style="background-color:' + this.options.timeoutProgressbarColor + '"></div></div>'),
                    "" === this.options.subtitle && this.$header.addClass(a + "-noSubtitle"),
                    "" !== this.options.title &&
                        ...
                        (null === this.options.icon && null === this.options.iconText) ||
                            ...
                            null !== this.options.iconText && this.$header.find("." + a + "-header-icon").html(this.options.iconText)),
            ...
            open: function (e) {
                ...
                function n() {
                    o.$element.off("click", "[data-" + a + "-close]").on("click", "[data-" + a + "-close]", function (e) {
                        ...
                        o.$element.off("click", "[data-" + a + "-fullscreen]").on("click", "[data-" + a + "-fullscreen]", function (t) {
                            t.preventDefault(),
                                o.isFullscreen === !0 ? ((o.isFullscreen = !1), o.$element.removeClass("isFullscreen")) : ((o.isFullscreen = !0), o.$element.addClass("isFullscreen")),
                ...
                if (
                    ...
                    if ((n(), this.setGroup(), (this.state = r.OPENING), this.$element.trigger(r.OPENING), this.$element.attr("aria-hidden", "false"), this.options.iframe === !0)) {
                        this.$element.find("." + a + "-content").addClass(a + "-content-loader"),
                    ...
                    (this.options.bodyOverflow || d) && (t("html").addClass(a + "-isOverflow"), d && t("body").css("overflow", "hidden")),
                                    ...
                                    ? "closeScreenEdge" === o.options.navigateArrows
                                        ...
                                        : (o.$navigate
                                          ...
                                          o.$navigate
                                              ...
                                              .show())
                                    : (o.$navigate.find("." + a + "-navigate-prev").hide(), o.$navigate.find("." + a + "-navigate-next").hide());
                                var s;
                                0 === o.group.index &&
                                    ((s = t("." + a + "[data-" + a + '-group="' + o.group.name + '"][data-' + a + "-loop]").length), 0 === s && o.options.loop === !1 && o.$navigate.find("." + a + "-navigate-prev").hide()),
                                    o.group.index + 1 === o.group.ids.length &&
                                        ((s = t("." + a + "[data-" + a + '-group="' + o.group.name + '"][data-' + a + "-loop]").length), 0 === s && o.options.loop === !1 && o.$navigate.find("." + a + "-navigate-next").hide());
                            }
                            o.options.overlay === !0 && (o.options.appendToOverlay === !1 ? o.$overlay.appendTo("body") : o.$overlay.appendTo(o.options.appendToOverlay)),
                                o.options.transitionInOverlay && o.$overlay.addClass(o.options.transitionInOverlay);
                            var r = o.options.transitionIn;
                            "object" == typeof e && ((void 0 === e.transition && void 0 === e.transitionIn) || (r = e.transition || e.transitionIn)),
                                "" !== r && void 0 !== l
            ...
            close: function (e) {
                function i() {
                    (n.state = r.CLOSED),
                        ...
                        n.options.iframe === !0 && n.$element.find("." + a + "-iframe").attr("src", ""),
                        (n.options.bodyOverflow || d) && (t("html").removeClass(a + "-isOverflow"), d && t("body").css("overflow", "auto")),
                        n.options.onClosed && "function" == typeof n.options.onClosed && n.options.onClosed(n),
                        n.options.restoreDefaultContent === !0 && n.$element.find("." + a + "-content").html(n.content),
                        0 === t("." + a + ":visible").length && t("html").removeClass(a + "-isAttached");
                }
                var n = this;
                if (this.state == r.OPENED || this.state == r.OPENING) {
                    ...
                    "object" == typeof e && ((void 0 === e.transition && void 0 === e.transitionOut) || (o = e.transition || e.transitionOut)),
                        o === !1 || "" === o || void 0 === l
                            ...
                            : (this.$element.attr(
                                  "class",
                                  [this.classes, a, o, "light" == this.options.theme ? a + "-light" : this.options.theme, this.isFullscreen === !0 ? "isFullscreen" : "", this.options.rtl ? a + "-rtl" : ""].join(" ")
                              ),
                              this.$overlay.attr("class", a + "-overlay " + this.options.transitionOutOverlay),
                              n.options.navigateArrows !== !1 && this.$navigate.attr("class", a + "-navigate fadeOut"),
            ...
            next: function (e) {
                ...
                (r.out = this),
                    void 0 !== e && "object" != typeof e
                        ? (e.preventDefault(), (s = t(e.currentTarget)), (n = s.attr("data-" + a + "-transitionIn")), (o = s.attr("data-" + a + "-transitionOut")))
                        : void 0 !== e && (void 0 !== e.transitionIn && (n = e.transitionIn), void 0 !== e.transitionOut && (o = e.transitionOut)),
            ...
            destroy: function () {
                ...
                this.$element.trigger(e),
                    ...
                    clearTimeout(this.timer),
                    clearTimeout(this.timerTimeout),
                    this.options.iframe === !0 && this.$element.find("." + a + "-iframe").remove(),
            ...
            setTitle: function (t) {
                (this.options.title = t),
                    ...
                    0 === this.$header.find("." + a + "-header-title").length && this.$header.append('<h2 class="' + a + '-header-title"></h2>'),
                    this.$header.find("." + a + "-header-title").html(t);
            },
            setSubtitle: function (t) {
                "" === t
                    ? (this.$header.find("." + a + "-header-subtitle").remove(), this.$header.addClass(a + "-noSubtitle"))
                    : (0 === this.$header.find("." + a + "-header-subtitle").length && this.$header.append('<p class="' + a + '-header-subtitle"></p>'), this.$header.removeClass(a + "-noSubtitle")),
                    this.$header.find("." + a + "-header-subtitle").html(t),
                    (this.options.subtitle = t);
            },
            setIcon: function (t) {
                0 === this.$header.find("." + a + "-header-icon").length && this.$header.prepend('<i class="' + a + '-header-icon"></i>'),
                    this.$header.find("." + a + "-header-icon").attr("class", a + "-header-icon " + t),
                    (this.options.icon = t);
            },
            ...
            startLoading: function () {
                this.$element.find("." + a + "-loader").length || this.$element.append('<div class="' + a + '-loader fadeIn"></div>'),
                    this.$element.find("." + a + "-loader").css({ top: this.headerHeight, borderRadius: this.options.radius });
            },
            stopLoading: function () {
                var t = this.$element.find("." + a + "-loader");
                t.length || (this.$element.prepend('<div class="' + a + '-loader fadeIn"></div>'), (t = this.$element.find("." + a + "-loader").css("border-radius", this.options.radius))),
            ...
            recalcVerticalPos: function (t) {
                null !== this.options.top && this.options.top !== !1
                    ...
                    : t === !1 && this.$element.css({ marginTop: "", borderRadius: this.options.radius }),
            ...
            recalcLayout: function () {
                var e = this,
                    ...
                    f = 0;
                i() && (d >= o.width() || this.isFullscreen === !0 ? this.$element.css({ left: "0", marginLeft: "" }) : this.$element.css({ left: "50%", marginLeft: -(d / 2) })),
                    this.options.borderBottom === !0 && "" !== this.options.title && (f = 3),
                    this.$element.find("." + a + "-header").length && this.$element.find("." + a + "-header").is(":visible")
                        ? ((this.headerHeight = parseInt(this.$element.find("." + a + "-header").innerHeight())), this.$element.css("overflow", "hidden"))
                        : ((this.headerHeight = 0), this.$element.css("overflow", "")),
                    this.$element.find("." + a + "-loader").length && this.$element.find("." + a + "-loader").css("top", this.headerHeight),
                    ...
                    (this.state != r.OPENED && this.state != r.OPENING) ||
                        (this.options.iframe === !0 &&
                            (s < this.options.iframeHeight + this.headerHeight + f || this.isFullscreen === !0
                                ? this.$element.find("." + a + "-iframe").css("height", s - (this.headerHeight + f))
                                : this.$element.find("." + a + "-iframe").css("height", this.options.iframeHeight)),
                        l == s ? this.$element.addClass("isAttached") : this.$element.removeClass("isAttached"),
                        this.isFullscreen === !1 && this.$element.width() >= o.width() ? this.$element.find("." + a + "-button-fullscreen").hide() : this.$element.find("." + a + "-button-fullscreen").show(),
                        this.recalcButtons(),
                        this.isFullscreen === !1 && (s = s - (n(this.options.top) || 0) - (n(this.options.bottom) || 0)),
                        c > s
                            ? (this.options.top > 0 && null === this.options.bottom && h < o.height() && this.$element.addClass("isAttachedBottom"),
                              this.options.bottom > 0 && null === this.options.top && h < o.height() && this.$element.addClass("isAttachedTop"),
                              t("html").addClass(a + "-isAttached"),
                              this.$element.css("height", s))
                            : (this.$element.css("height", h + (this.headerHeight + f)), this.$element.removeClass("isAttachedTop isAttachedBottom"), t("html").removeClass(a + "-isAttached")),
                        (function () {
        ...
        s.off("click", "[data-" + a + "-open]").on("click", "[data-" + a + "-open]", function (e) {
            ...
            void 0 !== s ? i.iziModal("close", { transition: s }) : i.iziModal("close"),
                setTimeout(function () {
        ...
        s.off("keyup." + a).on("keyup." + a, function (e) {
            if (t("." + a + ":visible").length) {
                ...
                void 0 === i ||
                    ...
                    (37 === o.keyCode ? t("#" + i).iziModal("prev", o) : 39 === o.keyCode && t("#" + i).iziModal("next", o));
            }
        }),
        (t.fn[a] = function (e, i) {
